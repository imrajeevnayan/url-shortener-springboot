...
('google', 'https://www.google.com', 'google', 'Google', 'Search engine', 15, DATEADD('DAY', -5, NOW()), DATEADD('DAY', 25, NOW()), DATEADD('HOUR', -2, NOW()), true, NULL),
('github', 'https://www.github.com', 'github', 'GitHub', 'Code repository', 42, DATEADD('DAY', -10, NOW()), DATEADD('DAY', 20, NOW()), DATEADD('HOUR', -5, NOW()), true, NULL),
('stackoverflow', 'https://www.stackoverflow.com', 'stackoverflow', 'Stack Overflow', 'Developer Q&A', 28, DATEADD('DAY', -3, NOW()), DATEADD('DAY', 27, NOW()), DATEADD('HOUR', -1, NOW()), true, NULL),
('youtube', 'https://www.youtube.com', 'youtube', 'YouTube', 'Video platform', 100, DATEADD('DAY', -15, NOW()), DATEADD('DAY', 15, NOW()), DATEADD('HOUR', -10, NOW()), true, NULL),
('linkedin', 'https://www.linkedin.com', 'linkedin', 'LinkedIn', 'Professional network', 8, DATEADD('DAY', -1, NOW()), DATEADD('DAY', 29, NOW()), DATEADD('HOUR', -20, NOW()), true, NULL),
('medium', 'https://www.medium.com', 'medium', 'Medium', 'Blogging platform', 35, DATEADD('DAY', -7, NOW()), DATEADD('DAY', 23, NOW()), DATEADD('HOUR', -3, NOW()), true, NULL),
('twitter', 'https://www.twitter.com', 'twitter', 'Twitter/X', 'Social media', 67, DATEADD('DAY', -12, NOW()), DATEADD('DAY', 18, NOW()), DATEADD('HOUR', -8, NOW()), true, NULL),
('reddit', 'https://www.reddit.com', 'reddit', 'Reddit', 'Community forum', 23, DATEADD('DAY', -4, NOW()), DATEADD('DAY', 26, NOW()), DATEADD('HOUR', -12, NOW()), true, NULL),
('wikipedia', 'https://www.wikipedia.org', 'wikipedia', 'Wikipedia', 'Encyclopedia', 56, DATEADD('DAY', -20, NOW()), DATEADD('DAY', 10, NOW()), DATEADD('HOUR', -15, NOW()), true, NULL),
('amazon', 'https://www.amazon.com', 'amazon', 'Amazon', 'E-commerce', 89, DATEADD('DAY', -8, NOW()), DATEADD('DAY', 22, NOW()), DATEADD('HOUR', -6, NOW()), true, NULL);
